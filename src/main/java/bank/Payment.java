...
public class Payment extends Transaction {
     ...
     */
    public void setIncomingInterest(double value) throws TransactionAttributeException {
        try {
     ...
     */
    public void setOutgoingInterest(double value) throws TransactionAttributeException {
        try {
    ...
    @Override
    public void setAmount(double value) throws TransactionAttributeException{
        if (value == 0.0) {
            throw new TransactionAttributeException();
        }
        else {
